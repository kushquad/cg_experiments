...
def getLiveNeighbors(x, y):
	...
	live_neighbor_list = filter(lambda x:x>0.95, 
...
def colorMap(color_idx):
	return [0.08, 0.23, 0.23, 0.23, 0.5, 0.5, 0.5, 1, 1][color_idx]
...
for k in xrange(steps):
	...
	surface.write_to_png("output/chip/conway_{}.png".format(str(k+1).zfill(4)))
	simulate()